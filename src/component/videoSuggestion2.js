      ...
      <Box sx={{ m: 2, p: 1 }}>
        ...
        <div className="videoRow">
          <div className="video">
            ...
            />
            <span>
              Aap Jo Is Tarah Se Tarpayenge(Cover)Real Heart Touching...
            </span>
          </div>
          ...
          <div className="video">
            ...
            />
            <span>
              Java Tutorial : Introduction to Object Oriented Programing
            </span>
          </div>
          <div className="video">
            <ReactPlayer
            ...
            />
            <span>
              Abstraction in Java||what is abstract class and abstract method in
              java (...
            </span>
          </div>
        </div>
